...
$(RELATIVE_ROOT_DIR)/$(CLIENT_BUILD_DIR)/%.cpp.o: $(RELATIVE_ROOT_DIR)/%.cpp
	mkdir -p $(dir $@)
	$(CC) $(CPP_FLAGS) $(CLIENT_HEADER_DIR_INCLUDES) -c $< -o $@ -MMD -MF $@.deps

$(RELATIVE_ROOT_DIR)/$(CLIENT_BUILD_DIR)/%.mm.o: $(RELATIVE_ROOT_DIR)/%.mm
	mkdir -p $(dir $@)
	$(CC) $(CPP_FLAGS) $(CLIENT_HEADER_DIR_INCLUDES) -c $< -o $@ -MMD -MF $@.deps

$(RELATIVE_ROOT_DIR)/$(CLIENT_BUILD_DIR)/%.m.o: $(RELATIVE_ROOT_DIR)/%.m
	mkdir -p $(dir $@)
