...
namespace Rendering {
  namespace Uniforms {
    ...
    void initialize() {
      ...
      list.mergeCameraWorldViewTransform = Backend::getUniform(mergeProgram, "cameraWorldViewTransform");
      list.mergeCameraViewClipTransform = Backend::getUniform(mergeProgram, "cameraViewClipTransform");
